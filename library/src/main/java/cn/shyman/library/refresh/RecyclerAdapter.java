...
public abstract class RecyclerAdapter {
	 ...
	 * @return 刷新列表项
	 */
	private <StatusInfo> RefreshHolder<StatusInfo> createRefreshHolder(ViewGroup parent) {
	 ...
	 * @return 加载列表项
	 */
	private <StatusInfo> LoadHolder<StatusInfo> createLoadHolder(ViewGroup parent) {
